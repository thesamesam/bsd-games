...
// differently.
void bsect(int b, int rpos, int cpos, int cnext)	// direction of position
{
    int j;			// index
...
void fixpos(int old, int new, int r, int c, int inc)
{
    int o, n, nv;
    int ov, nc;
    char col;
...
void fixcol(int r, int c, int l, int ch, int inc)
{
    int i;
...
void fancyc(int c)		// character to output
{
